...
# 문법 2. 작성한 컬럼 값 제공
insert into     # menu_code 제외 -> 자동으로 null -> auto increment
    tbl_menu(menu_price,
             orderable_status,
             menu_name,
             category_code)
...
select * from tbl_menu; # 두 번 실행해서 9,000원 -> 10,000원
...
select * from tbl_menu; # 28번 메뉴 소시지커피 삭제
